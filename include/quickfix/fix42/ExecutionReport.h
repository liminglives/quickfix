...
namespace FIX42
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::DeclarationID);
    FIELD_SET(*this, FIX::TradeID);
    FIELD_SET(*this, FIX::ArrivalPrice);
    FIELD_SET(*this, FIX::TargetProgress);
    FIELD_SET(*this, FIX::VWapMarketPrice);
    FIELD_SET(*this, FIX::NotificationReason);
    FIELD_SET(*this, FIX::StrategyStatus);
    FIELD_SET(*this, FIX::RealParticipationRate);
