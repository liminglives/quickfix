...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int StrategyType = 3001;
    const int StartTime = 3002;
    const int EndTime = 3003;
    const int ParticipationRate = 849;
    const int Style = 3005;
    const int MinVolParticipation = 3006;
    const int RefPrice = 3007;
    const int OPG = 3008;
    const int MOC = 3009;
    const int MinDisplaySize = 3010;
    const int CountEligibleVolumewithinLimitPrice = 3011;
    const int ResetEligibleVolumewithinLimitPrice = 3012;
    const int MaxPriceLevels = 1090;
    const int MaxOrdersPerLevels = 3014;
    const int RelativePriceLimitBase = 3015;
    const int RelativePriceLimitType = 3016;
    const int RelativePriceLimitOffset = 3017;
    const int AMOpenPercent = 3018;
    const int PMClosePercent = 3019;
    const int AMPercent = 3020;
    const int StrategyStatus = 3100;
    const int PauseType = 3101;
    const int TargetProgress = 3102;
    const int EligibleMarketQty = 3103;
    const int EligibleMarketAmt = 3104;
    const int SerialNum = 3105;
    const int RegId = 3106;
    const int BatchNum = 3107;
    const int NotificationReason = 3108;
    const int VWapMarketPrice = 3109;
    const int RealParticipationRate = 3110;
    const int ArrivalPrice = 3111;
    const int UserId = 3112;
    const int QtyMode = 3113;
    const int CloseFlag = 7001;
    const int LogonPasswd = 8001;
    const int LogonStatus = 8002;
    const int AccountName = 8003;
    const int RiskLevel = 8004;
    const int AdditionalMargin = 8005;
    const int ClientSecuType = 8006;
    const int LastLogonIP = 8007;
    const int LastLogonTime = 8008;
    const int HedgeFlag = 8009;
    const int TouchCondition = 8010;
    const int Riskratio = 8011;
    const int LatestPx = 8012;
    const int InformationID = 8013;
    const int TotalExMarginAmt = 8014;
    const int TdPosition = 8015;
    const int YDPosition = 8016;
    const int FrozenPosition = 8017;
    const int FrozenAmt = 8018;
    const int PositionDate = 8019;
    const int FrozenCommision = 8020;
    const int PositionProfit = 8021;
    const int PositionPrice = 8022;
    const int MaxOpenPosition = 8023;
    const int MaxClosePosition = 8024;
    const int MaxCloseTdPosition = 8025;
    const int TotalRetNum = 8026;
    const int PresentRetNum = 8027;
    const int SettlementDate = 8028;
    const int SettlementConfirm = 8029;
    const int SettlementConfirmResult = 8030;
    const int SpecLongMarginRate = 8031;
    const int SpecShortMarginRate = 8032;
    const int HedgeLongMarginRate = 8033;
    const int HedgeShortMarginRate = 8034;
    const int SpecLongMarginAmt = 8035;
    const int SpecShortMarginAmt = 8036;
    const int HedgeLongMarginAmt = 8037;
    const int HedgeShortMarginAmt = 8038;
    const int OpenCommissionRate = 8039;
    const int OpenCommissionAmt = 8040;
    const int CloseCommissionRate = 8041;
    const int CloseCommissionAmt = 8042;
    const int CloseTdCommissionRate = 8043;
    const int CloseTdCommissionAmt = 8044;
    const int BuyMarginAmt = 8045;
    const int SellMarginAmt = 8046;
    const int SupplementalMarginAmt = 8047;
    const int OccupyMarginAmt = 8048;
    const int TotalMarginAmt = 8049;
    const int PreSettlementPrice = 8050;
    const int PreClosePrice = 8051;
    const int PreHoldPosition = 8052;
    const int OpenPrice = 8053;
    const int HighestPrice = 8054;
    const int LowestPrice = 8055;
    const int HoldPosition = 8056;
    const int ClosePrice = 8057;
    const int SettlementPrice = 8058;
    const int UpperLimitPrice = 8059;
    const int LowerLimitPrice = 8060;
    const int BidQty = 8061;
    const int AskQty = 8062;
    const int UpdateTime = 8063;
    const int UpdateMillisec = 8064;
    const int NoOfferPriceLevel = 8065;
    const int NoBidPriceLevel = 8066;
    const int GapMessageType = 8067;
    const int GapStartNum = 8068;
    const int GapEndNum = 8069;
    const int ChangePWResult = 8070;
    const int RequestMsgType = 8071;
    const int ErrorCode = 8072;
    const int ExchangeName = 8073;
    const int TotalFrozenAmt = 8074;
    const int OneLotQty = 8075;
    const int MaxLotQty = 8076;
    const int MaxHoldPosition = 8077;
    const int VarietyCode = 8078;
    const int VarietyName = 8079;
    const int MinPxAlterUnit = 8080;
    const int YesterdayStlAmt = 8081;
    const int BuyFrozenAmt = 8082;
    const int SellFrozenAmt = 8083;
    const int UseableAmt = 8084;
    const int FloatProfit = 8085;
    const int CloseProfit = 8086;
    const int DayFolatProfit = 8087;
    const int RequestID = 8088;
    const int PassWdType = 8089;
    const int OldPassWd = 8090;
    const int NewPassWd = 8091;
    const int SettleFee = 8092;
    const int DeclarationID = 8093;
    const int TradeID = 1003;
    const int NextFlag = 8095;
    const int IPAddress = 8096;
    const int MacAddress = 8097;
    const int FetchAmt = 8098;
    const int DayPaymentAmt = 8099;
    const int DayIncomeAmt = 8100;
    const int OrderEntryTime = 8500;
